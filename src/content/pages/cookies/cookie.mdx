...
##COOKIE POLICY OF ETCCOOPERATIVE.ORG

**1. Introduction**

Our website, etccooperative.org (hereinafter: "the website") uses cookies and similar technologies (for convenience, all such technologies are referred to as "cookies"). Cookies are also placed by third parties we have engaged. In the document below, we inform you about the use of cookies on our website.
...
We use analytical cookies to optimize the website experience for our users. With these analytical cookies, we get insights into the usage of our website.
